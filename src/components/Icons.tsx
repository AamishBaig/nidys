...
export const ChiliIcon: React.FC<IconProps & { bodyColor?: string, stemColor?: string }> = ({ className, bodyColor, stemColor }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <path d="M13.2,3.4c-0.8-2.3,1.3-4,2.9-2.9C15.1,1.9,13.8,2.5,13.2,3.4z" fill={stemColor || '#6B7281'}/>
        <path d="M15.4,5.4c2.1,4.3,2,9.6-1,13.9c-2.4,3.4-6.3,4.4-9.3,2.2c1.9-3.4,3.2-6.9,4-10.7C9.8,6.9,12.5,4.5,15.4,5.4z" fill={bodyColor || '#6B7281'}/>
    </svg>
);
...
export const CalendarDaysIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25m10.5-2.25v2.25M3.75 6A2.25 2.25 0 016 3.75h12A2.25 2.25 0 0120.25 6v12A2.25 2.25 0 0118 20.25H6A2.25 2.25 0 013.75 18V6zM3.75 9h16.5" />
    </svg>
);
